...
export class DSLParser {
  ...
  public parse(input: string): DSLCommand[] {
    ...
    if (commands.length === 0) {
      throw new ParseError('No valid commands found', ParseErrorType.SYNTAX_ERROR);
    }
  ...
  private parseParameters(paramsStr: string, commandType: CommandType, lineNumber: number): any[] {
  ...
  private parseStyleParameters(params: string[], lineNumber: number): Record<string, string> {
  ...
  private parseLineParameters(params: string[], lineNumber: number): [number, number, number, number] {
    if (params.length !== 2) {
      throw new ParseError(
  ...
  private parseRectParameters(params: string[], lineNumber: number): [number, number, number, number] {
    if (params.length !== 2) {
      throw new ParseError(
  ...
  private parseCircleParameters(params: string[], lineNumber: number): [number, number, number] {
    if (params.length !== 2) {
      throw new ParseError(
  ...
  private parseTextParameters(params: string[], lineNumber: number): [number, number, string] {
    if (params.length !== 2) {
      throw new ParseError(
  ...
  private parsePathParameters(params: string[], lineNumber: number): Array<{x: number, y: number}> {
    if (params.length < 2) {
      throw new ParseError(
  ...
  private parseActionParameters(params: string[], lineNumber: number): [number, number, number, number, string] {
    if (params.length !== 3) {
      throw new ParseError(
  ...
  private parseCoordinate(coordStr: string, lineNumber: number): {x: number, y: number} {
